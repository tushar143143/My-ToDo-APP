...
function Todos() {
  ...
  return (
    <>
      <div className='font-serif text-2xl'>Todos</div>
      <ul className="list-none">
        {todos.map((todo) => (
          <li
            className={`mt-4 flex justify-between items-center bg-slate-800 px-4 py-2 rounded ${todo.completed ? 'line-through' : ''}`}
            key={todo.id}
          >
